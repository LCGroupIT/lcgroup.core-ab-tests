...
export abstract class AbstractUserAgentCrawlerDetector {
    ...
    private _regexps: RegExp = /googlebot|http:\/\/yandex\.com\/bots|Aport|StackRambler|Mail.RU|yahoo|bingbot|baiduspider|twitterbot|facebookexternalhit|rogerbot|linkedinbot|embedly|quora link preview|showyoubot|outbrain|pinterest|slackbot|vkShare|W3C_Validator|redditbot|Applebot|WhatsApp|flipboard|tumblr|bitlybot/;
