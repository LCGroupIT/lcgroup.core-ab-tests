...
import { AbTestsModule, AbTestOptions } from '@lcgroup.core/ab-tests';
...
import { AbTestsService } from '@lcgroup.core/ab-tests';
...
```typescript
import { NgModule } from '@angular/core';
import { AbTestsServerModule } from '@lcgroup.core/ab-tests';
...
- set test and emit
```typescript
  this.abTestsService.setTestAndEmitStarted('myScope', ['v1', 'v2']); // the second parameter takes AbTestOptions or array of versions
```
